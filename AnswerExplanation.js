...
function describeValue(value) {
  ...
  //return typeof value || (value === null ? "null" : (value ? "Truthy" : "Falsy") || typeof value === "undefined" ? "undefined" : "object");
}
console.log(describeValue(NaN)); // Output: "undefined"
...
console.log(validateUsername("1admin1le"));
...
//jodi distance 2 km ar kom hoi tahole ata fare ta 50 e nibe, then jodi ar besi jai tobe extra 50 ar sathe + 15 taka add hobe per km a
  ...
  // ai khane jodi car kono jagai wait korai per min 2 taka extra pay korte hobe take, ata calculate korci
...
console.log(getCngFare(5,true,9));
